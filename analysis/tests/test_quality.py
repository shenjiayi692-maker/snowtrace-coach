...
class QualityTests(unittest.TestCase):
    def test_good_fixed_camera_can_pass_full(self):
        ...
        result = build_quality_gate(track, turns, blur_score=90, exposure_score=90, stability_score=90, camera_mode="fixed")
    ...
    def test_follow_camera_is_limited(self):
        track = track_with_quality(100, 0.92, 0.42)
        turns = [Turn(index, "unknown", index * 1000, index * 1000 + 400, index * 1000 + 800, 0.9) for index in range(3)]
        result = build_quality_gate(track, turns, blur_score=90, exposure_score=90, stability_score=90, camera_mode="follow")
    ...
    def test_blocked_clarity_limits_metrics_without_rejecting_clip(self):
        ...
        result = build_quality_gate(track, turns, blur_score=20, exposure_score=90, stability_score=90, camera_mode="fixed")
