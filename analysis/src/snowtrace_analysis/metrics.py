...
from .contracts import MetricSeries, RiderTrack
from .geometry import line_angle, midpoint, safe_angle, signed_axis_projection, wrapped_angle_difference


def compute_metric_series(track: RiderTrack) -> list[MetricSeries]:
    ...
    for observation in track.observations:
        ...
        ankle_axis = landmarks[28, :2] - landmarks[27, :2]
        ...
        values = {
            "knee_flexion_lead": left_knee,
            "knee_flexion_trail": right_knee,
            "pelvis_height": pelvis_height,
            "projected_inclination": inclination,
            "fore_aft_pelvis": fore_aft,
            "upper_lower_separation": separation,
            "lead_trail_differential": left_knee - right_knee,
        }
